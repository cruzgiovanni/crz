...
export function MagneticButton({
  ...
  const variants = {
    primary:
      'bg-[#cba6f7] text-[#11111b] hover:bg-[#cba6f7]/90 backdrop-blur-md hover:scale-[1.02] active:scale-[0.98]',
    secondary:
      'bg-foreground/5 text-foreground hover:bg-foreground/10 backdrop-blur-xl border border-foreground/15 hover:border-[#cba6f7]/30',
