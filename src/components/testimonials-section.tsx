    ...
    <section id="testimonials" ref={sectionRef} className="relative pt-16 pb-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16 md:mb-32">
          ...
          <h2 className="fade-in-element opacity-0 translate-y-8 transition-all duration-1000 ease-out text-5xl md:text-6xl lg:text-7xl font-light text-white mb-8 tracking-tight text-balance font-[family-name:var(--font-dm-serif)]">
